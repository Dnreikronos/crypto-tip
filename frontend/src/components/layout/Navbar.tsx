...
import { Menu, X, Coins, LogOut, Briefcase, LayoutDashboard, UserPlus, LogIn as LogInIcon } from 'lucide-react';
...
export default function Navbar() {
  ...
  const navButtonGradientColors = "bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 focus:ring-cyan-300 text-white";
