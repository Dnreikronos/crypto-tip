...
export default function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen w-full flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative"
    >
      ...
      >
        ...
        <motion.h2
          ...
          variants={fadeInUp}
        >
          The developer-first platform to receive cryptocurrency donations for
