...
export default function HowItWorksSection() {
  const steps = [
    ...
    },
    {
      ...
      description:
        "Add your projects, funding goals, and personalize your profile.",
      color: "bg-blue-500",
    },
    {
      ...
      description:
        "Add your CryptoTip link to your GitHub, social media, or website.",
      color: "bg-indigo-500",
    },
    {
      ...
      description:
        "Get cryptocurrency directly to your wallet with zero platform fees.",
      color: "bg-purple-500",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Start receiving crypto donations for your development work in just a
            few simple steps.
          </p>
        </motion.div>
        ...
        <div className="relative">
          <div className="hidden lg:block">
            <div className="flex justify-between items-start max-w-5xl mx-auto relative">
              <svg
                className="absolute top-24 w-full h-20 z-0"
              ...
              {steps.map((step, index) => (
                ...
                >
                  <div
                    className={`${step.color} rounded-full h-16 w-16 flex items-center justify-center mb-5 shadow-lg`}
                  >
                    {step.icon}
                  </div>
          ...
          <div className="lg:hidden">
            <div className="flex flex-col items-center max-w-md mx-auto relative">
              <svg
                className="absolute left-1/2 -translate-x-1/2 h-full w-4 z-0"
                viewBox="0 0 20 800"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
