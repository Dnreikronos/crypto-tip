  ...
  const projects = [
    {
      ...
      description:
        "A lightweight authentication library for Web3 applications that supports multiple wallets and chains.",
    ...
    },
    {
      ...
      description:
        "Open-source API for blockchain data with comprehensive documentation and easy integration.",
    ...
    },
    {
      ...
      description:
        "Customizable trading bot for cryptocurrency markets with advanced strategy implementation.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            See how developers are using Crypto Tip to fund their open-source
            projects.
          </p>
        </motion.div>
